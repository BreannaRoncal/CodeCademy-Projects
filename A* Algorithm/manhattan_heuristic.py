"""
Modify Dijkstra's Algorithm to an A* Algorithm with the Manhattan Heuristic:
    - Works in a grid system where the the search can only move in up, down, left, and right directions
    - Never overestimates the distance to reach the target
    - Measure the distance between the x positional values and y positional values
    - Return the sum of x distance and y distance
